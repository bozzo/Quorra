...
#define QUORRA_SQUEEZESLAVE_PATH "/org/bozzo/Quorra/plg/SqueezeSlaveObject"
#define QUORRA_SQUEEZESLAVE_SERVICE_NAME "org.bozzo.Quorra.plg.SqueezeSlaveObject"
